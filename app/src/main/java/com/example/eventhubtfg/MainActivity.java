...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_gallery, R.id.nav_slideshow, R.id.nav_perfil, R.id.nav_logout, R.id.nav_calendar)
        ...
        logoutMenuItem.setOnMenuItemClickListener(item -> {
            try {
                ...
                Toast.makeText(MainActivity.this, "Error al cerrar sesión: " + e.getMessage(), Toast.LENGTH_SHORT).show();
            }
            return true;
        });
    }
